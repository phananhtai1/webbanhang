			...
			<div class="row">
				...
				<div id="search" class="col-md-7 col-sm-12 col-xs-12">
					<form method="get" action="{{asset('search/')}}">
						<input type="text" required class="form-control" name="result" placeholder="Nhập từ khóa ...">
						<button type="submit" title="Tìm kiếm" class="btn btn-default btn-search" name="submit"><i class="fas fa-search"></i></button>
					</form>
				</div>
				...
				<div class="container">
					<div class="row">
						<div id="footer-b-l" class="col-md-6 col-sm-12 col-xs-12 text-center">
							<p>Cửa hàng điện thoại BiuBiu - www.biubiu.edu.vn</p>
						</div>
						<div id="footer-b-r" class="col-md-6 col-sm-12 col-xs-12 text-center">
							<p>© 2005 BiuBiu Shop. All Rights Reserved</p>
						</div>
					</div>
				</div>
				<div id="scroll">
