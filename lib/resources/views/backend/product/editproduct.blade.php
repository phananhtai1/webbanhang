						...
						<div class="row" style="margin-bottom:40px">
							<div class="col-xs-8">
								...
								<div class="form-group">
									...
									<img id="avatar" class="thumbnail" width="300px" src="{{asset('lib/storage/app/avatarProduct/'.$product->prod_img)}}">
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<select required name="cate" class="form-control">
										...
										<option value="{{$cat->cat_id}}" @if($product->prod_cat == $cat->cat_id) selected @endif>{{$cat->cat_name}}</option>
										@endforeach
									</select>
								</div>
								<div class="form-group">
								...
								<a href="#" title="Hủy cập nhật sản phẩm" class="btn btn-danger">Hủy bỏ</a>
							</div>
						</div>
						{{csrf_field()}}
					</form>
